...
export type ReplaceProperty<$Obj extends object, $Key extends keyof $Obj, $NewType> = Omit<$Obj, $Key> & {
    [_ in $Key]: $NewType;
};
...
export declare const mapValues: <rec extends Record<PropertyKey, any>, newValue>(obj: rec, fn: (value: rec[keyof rec], key: keyof rec) => newValue) => Record<PropertyKey, newValue>;
