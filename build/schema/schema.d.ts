...
export declare const is: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions | number) => u is {
    ...
    readonly version: import("../version/integer.ts").Integer | import("../version/semver.ts").Semver | import("../version/date.ts").Date | import("../version/custom.ts").Custom;
...
export declare const getVersion: (schema: Schema) => import("../version/integer.ts").Integer | import("../version/semver.ts").Semver | import("../version/date.ts").Date | import("../version/custom.ts").Custom | undefined;
