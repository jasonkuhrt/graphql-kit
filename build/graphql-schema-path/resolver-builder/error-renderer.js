...
// Path Rendering
// ============================================================================
export const renderPathWithError = (error) => {
...
// Options Rendering
// ============================================================================
const renderAvailableOptions = (options) => {
...
// Main Error Renderer
// ============================================================================
export const renderTraversalError = (error) => {
    const lines = [];
 ...
 */
export const renderTraversalErrorConcise = (error) => {
 ...
 */
export const toDiagnosticMessage = (error) => {
    // Build the path string from location
    const pathParts = [];
    // Add parent chain
    if (error.location.parentChain.length > 0) {
